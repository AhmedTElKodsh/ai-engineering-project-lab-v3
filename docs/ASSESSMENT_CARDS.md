...
Readiness advancement and final J5 completion are defined once in [the progress protocol](PROGRESS_PROTOCOL.md) and summarised once in [the route](CURRICULUM.md); a third restatement here would be the duplication that pointer exists to remove.
