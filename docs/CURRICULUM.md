...
2. Write a visible ingestion/chunking step. Use the embedding route recorded in [DR-001](DECISIONS.md) and NumPy similarity; read its Arabic consequence before building the language evaluation. Inspect retrieved chunks before generation.
